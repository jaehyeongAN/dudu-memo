    ...
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
      ...
      <div className="flex mb-4">
        <input
          ...
          className="flex-grow rounded-l-lg px-4 py-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
          placeholder="새로운 할 일 추가..."
        />
        <button
          onClick={addTodo}
          className="bg-indigo-500 text-white px-6 py-2 rounded-r-lg hover:bg-indigo-600 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
        >
          ...
          >
            <div className="p-4">
              ...
              <input
                ...
                className="mt-2 w-full px-3 py-1 text-sm text-gray-600 bg-gray-50 rounded border border-gray-200 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                placeholder="설명 추가..."
              />
